...
export default function LoginForm({ onSwitch }: LoginFormProps) {
  ...
  return (
    <form
      ...
      className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md font-sans border border-green-50"
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full py-3.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium text-sm shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {loading ? (
