  ...
  return (
    <>
      <form
        ...
        className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md font-sans space-y-4"
      >
        ...
        <div>
          <label htmlFor="licenseNo" className="block text-black mb-1">
            License Number
          </label>
          <input
            id="licenseNo"
        ...
        <div>
          <label htmlFor="licensedBy" className="block text-black mb-1">
            Licensed By
          </label>
          <input
            id="licensedBy"
        ...
        <div>
          <label htmlFor="operationDate" className="block text-black mb-1">
            Operation Date
          </label>
          <input
            id="operationDate"
        ...
        <div>
          <label htmlFor="capital" className="block text-black mb-1">
            Capital (USD)
          </label>
          <input
            id="capital"
        ...
        <div className="flex space-x-4">
          ...
          <div className="flex-1">
            <label htmlFor="postalCode" className="block text-black mb-1">
              Postal Code
            </label>
            <input
              id="postalCode"
      ...
      {successOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-transparent backdrop-blur-sm z-20">
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6 border-2 ">
            <h3 className="text-lg font-semibold text-green-700 text-center">
              Registration Successful!
            </h3>
            <p className="mt-4 text-center text-gray-700">
              You will be sent a notification once your company is approved. Don't forget to change your password after your first login.
